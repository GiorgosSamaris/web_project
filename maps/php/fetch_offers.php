...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // $store_id = 1;
    $store_offers = $conn->prepare("SELECT o.offer_id, p.name, u.username, c.overall_score, p.product_id, o.offer_price, o.number_of_likes, o.number_of_dislikes, o.in_stock, o.creation_date,o.price_decrease_last_day_avg, o.price_decrease_last_week_avg, o.store_id
